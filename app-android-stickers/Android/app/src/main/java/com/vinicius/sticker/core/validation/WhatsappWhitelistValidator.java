...
public class WhatsappWhitelistValidator {
   ...
   private static boolean isWhitelistedFromProvider(
       @NonNull Context context,
       @NonNull String identifier, String whatsappPackageName
   ) {
   ...
   public static boolean isWhatsAppConsumerAppInstalled(PackageManager packageManager) {
      return WhatsappWhitelistValidator.isPackageInstalled(
   ...
   public static boolean isStickerPackWhitelistedInWhatsAppConsumer(
       @NonNull Context context,
       @NonNull String identifier
   ) {
   ...
   public static boolean isStickerPackWhitelistedInWhatsAppSmb(
       @NonNull Context context,
       @NonNull String identifier
   ) {
