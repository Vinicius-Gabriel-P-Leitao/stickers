...
public class StickerPackValidator {
   ...
   private static void validateSticker(
       @NonNull Context context,
       @NonNull
      ...
      try {
         ...
         if ( !animatedStickerPack &&
            ...
            throw new IllegalStateException("static sticker should be less than " +
                                                ...
                                                "KB, current file is " +
                                                stickerInBytes.length / KB_IN_BYTES +
         ...
         try {
            ...
            if ( animatedStickerPack ) {
               if ( webPImage.getFrameCount() <= 1 ) {
                  throw new IllegalStateException(
                      "this pack is marked as animated sticker pack, all stickers should animate, sticker pack identifier: " +
                          identifier +
                          ", filename: " +
                          fileName);
               }
   ...
   private static void checkStringValidity(
