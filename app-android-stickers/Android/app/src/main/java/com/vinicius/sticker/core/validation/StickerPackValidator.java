...
public class StickerPackValidator {
   ...
   public static void verifyStickerPackValidity(
       ...
       @NonNull StickerPack stickerPack) throws IllegalStateException {
      ...
      try {
         final byte[] stickerAssetBytes = StickerPackLoader.fetchStickerAsset(
   ...
   private static void validateStickerFile(
      ...
      try {
         ...
         try {
            final WebPImage webPImage = WebPImage.createFromByteArray(
                stickerInBytes,
   ...
   private static void checkFrameDurationsForAnimatedSticker(
       @NonNull final int[] frameDurations,
       @NonNull final String identifier,
       @NonNull final String fileName) {
   ...
   private static boolean isURLInCorrectDomain(
       String urlString,
       String domain) throws IllegalStateException {
      try {
