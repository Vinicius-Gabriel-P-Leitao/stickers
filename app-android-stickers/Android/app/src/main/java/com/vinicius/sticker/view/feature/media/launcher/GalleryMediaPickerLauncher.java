...
import static com.vinicius.sticker.view.feature.media.util.CursorFindUriMedia.getMediaUris;
...
import com.vinicius.sticker.view.feature.media.presentation.MediaPickerBottomSheetDialogFragment;
...
public class GalleryMediaPickerLauncher {
   ...
   public static void launchOwnGallery(
      ...
      MediaPickerBottomSheetDialogFragment sheet = new MediaPickerBottomSheetDialogFragment(uris,
          namePack, isAnimatedPack, new PickMediaListAdapter.OnItemClickListener() {
         @Override
