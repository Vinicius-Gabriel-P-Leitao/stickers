    ...
    public static StickerFileException durationExceeded(String stickerPackIdentifier, String fileName, int minDuration)
        {
            String message = String.format(
                    Locale.ROOT, "O limite mínimo de duração de um quadro da figurinha animada é %d ms. Pacote: %s, Arquivo: %s", minDuration,
                    stickerPackIdentifier, fileName);

            return new StickerFileException(message, StickerAssetErrorCode.ERROR_STICKER_DURATION, stickerPackIdentifier, fileName);
        }
    ...
    public static StickerFileException staticFileTooLarge(String stickerPackIdentifier, String fileName, int maxKb, int actualKb)
        {
            return new StickerFileException(
                    String.format(
                            ...
                            maxKb, actualKb, stickerPackIdentifier, fileName), StickerAssetErrorCode.ERROR_FILE_SIZE, stickerPackIdentifier,
                    fileName);
        }
    ...
    public static StickerFileException invalidHeight(String stickerPackIdentifier, String fileName, int expected, int actual)
        {
            return new StickerFileException(
                    String.format(
                            Locale.ROOT, "A altura da figurinha deve ser %d, a altura atual é %d, identificador do pacote: %s, arquivo: %s", expected,
                            actual, stickerPackIdentifier, fileName), StickerAssetErrorCode.ERROR_SIZE_STICKER, stickerPackIdentifier, fileName);
        }
    ...
    public static StickerFileException invalidWidth(String stickerPackIdentifier, String fileName, int expected, int actual)
        {
            return new StickerFileException(
                    String.format(
                            Locale.ROOT, "A largura da figurinha deve ser %d, a largura atual é %d, identificador do pacote: %s, arquivo: %s",
                            expected, actual, stickerPackIdentifier, fileName), StickerAssetErrorCode.ERROR_SIZE_STICKER, stickerPackIdentifier,
                    fileName);
        }
    ...
    public static StickerFileException expectedAnimatedButGotStatic(String stickerPackIdentifier, String fileName)
        {
            return new StickerFileException(
                    String.format(
                            ...
                            stickerPackIdentifier, fileName), StickerAssetErrorCode.ERROR_STICKER_TYPE, stickerPackIdentifier, fileName);
        }
    ...
    public static StickerFileException durationExceeded(String stickerPackIdentifier, String fileName, int maxDuration, int actualDuration)
        {
            return new StickerFileException(
                    String.format(
                            Locale.ROOT, "A duração máxima da animação é: %d ms, a duração atual é: %d ms, identificador do pacote: %s, arquivo: %s",
                            maxDuration, actualDuration, stickerPackIdentifier, fileName), StickerAssetErrorCode.ERROR_STICKER_DURATION,
                    stickerPackIdentifier, fileName);
        }
    ...
    public static StickerFileException invalidWebP(String stickerPackIdentifier, String fileName)
        {
            return new StickerFileException(
                    String.format(
                            Locale.ROOT, "Erro ao processar a imagem WebP. Identificador do pacote: %s, arquivo: %s", stickerPackIdentifier,
                            fileName), StickerAssetErrorCode.ERROR_FILE_TYPE, stickerPackIdentifier, fileName);
        }

    public static StickerFileException fromStickerValidity(@NonNull String stickerPackIdentifier)
        {
            return new StickerFileException("Figurinha inválida.", StickerAssetErrorCode.ERROR_FILE_SIZE, stickerPackIdentifier, null);
        }

    public static StickerValidatorException missingStickerFileName(String stickerPackIdentifier, @Nullable String fileName)
        {
            return new StickerValidatorException(
                    String.format("Nenhum caminho de figurinha para o figurinha, identificador do pacote de figurinhas: %s", stickerPackIdentifier),
                    StickerAssetErrorCode.INVALID_STICKER_PATH, stickerPackIdentifier, fileName);
        }
    ...
    public static StickerValidatorException accessibilityTextTooLong(String stickerPackIdentifier, String fileName)
        {
            return new StickerValidatorException(
                    String.format(
                            ...
                            stickerPackIdentifier, fileName), StickerPackErrorCode.INVALID_STICKER_ACCESSIBILITY, stickerPackIdentifier, fileName);
        }
}
