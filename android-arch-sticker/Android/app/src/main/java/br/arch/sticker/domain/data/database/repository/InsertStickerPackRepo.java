    ...
    public CallbackResult<StickerPack> insertStickerPack(StickerPack stickerPack)
        {
            ...
            if (stickerPackId != -1) {
                ...
                return CallbackResult.failure(new StickerPackSaveException("Erro ao inserir detalhe dos pacotes.", SaveErrorCode.ERROR_PACK_SAVE_DB));
            }
        }
    ...
    public static ContentValues writeStickerPackToContentValues(StickerPack stickerPack, long stickerPackId)
        {
            ...
            stickerPackValues.put(ANIMATED_STICKER_PACK, stickerPack.animatedStickerPack
                                                         ? 1
                                                         : 0);
            ...
            stickerPackValues.put(AVOID_CACHE, stickerPack.avoidCache
                                               ? 1
                                               : 0);
