...
public enum ErrorCode {
    ...
    ERROR_EMPTY_STICKERPACK(R.string.error_empty_stickers_sticker_pack),
    ERROR_PACK_DELETE_DB(R.string.error_delete_sticker_pack_db),
    ERROR_STICKER_DELETE_DB(R.string.error_delete_sticker_list_db),
    ERROR_PACK_DELETE_SERVICE(R.string.error_delete_sticker_pack_service),
    ERROR_PACK_DELETE_UTIL(R.string.error_delete_sticker_pack_util),
    ERROR_PACK_DELETE_UI(R.string.error_delete_sticker_pack_ui),
    ...
    INVALID_STICKERPACK_SIZE(R.string.error_invalid_sticker_pack_size),
    ...
    ERROR_PACK_SAVE_DB(R.string.error_save_sticker_pack_db),
    ERROR_PACK_SAVE_SERVICE(R.string.error_save_sticker_pack_service),
    ERROR_PACK_SAVE_UTIL(R.string.error_save_sticker_pack_util),
    ERROR_PACK_SAVE_UI(R.string.error_save_sticker_pack_ui),
